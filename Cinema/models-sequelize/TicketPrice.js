...
module.exports.update = function(id, typeofmovie,typeoftimeframe,typeofday,typeofchair,price,status, callback) {
...
exports.getAllRoom = function(callback) { 
    TicketPrice.findAll({where:{status: 1}}).then(function(ticketprices) {
        var ticketpriceList = []; 
