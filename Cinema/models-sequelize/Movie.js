...
module.exports.create = function(name, description, image, duration, director, actornactress, language, nation, startday, format, urltrailer, ages, category,content, callback) {
    Movie.create({
        id: '',
        name:name,
...
module.exports.update = function(id, name,description,image,duration,director,
    actornactress,language,nation,startday,format,urltrailer,type,category,content,status,callback) {
